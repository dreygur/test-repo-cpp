...
#define CC1101_RESERVED_0X20     0x20      /*  RESERVED_0X20 - Reserved register */
#define CC1101_RESERVED_0X29     0x29      /*  RESERVED_0X29 - Reserved register */
#define CC1101_RESERVED_0X2A     0x2A      /*  RESERVED_0X2A - Reserved register */
#define CC1101_RESERVED_0X2B     0x2B   
...
extern uint8_t RF_CRCsOKFlag;

// PATABLE values
#define PA_LowPower               0x60
#define PA_LongDistance           0xC0
#define PKTLEN              61//10
#define CC1101_RECEIVE_LOOP_TIMEOUT  100 //In ms

#define  GPIO_GD0  GPIO_PIN_13

#define CC1101_TRANSMISSION_TIMEOUT	500 // time in milliseconds
 ...
 * CC1101
 * 
 * Set device address -1 for broadcase 0xFF
 */ 
 ...
 */
uint8_t CC1101_readReg(uint8_t regAddr, byte regType);
 ...
 */
 //uint8_t freq=CFREQ_868, uint8_t mode=0  was in cpp
 ...
 */
void CC1101_setSyncWord2(uint8_t *sync);
...
/*
* Check the version to determine if the chip exist and we can at least communicate it with read access
*/
bool CC1101_IsExist(void);

void CC1101_setTxPowerAmp(uint8_t paLevel);  

void CC1101_PrintDefaultRegs(void);
void CC1101_ReceiveRoutineFlagsInit(void);
uint8_t Data4Sensor(uint8_t *arr2analyze);

extern uint8_t Write2UARTFlag;
extern uint8_t StartRXFlag;
extern uint8_t PayloadSize4print;
extern uint32_t timeSample4RFRecevingTimeout;
